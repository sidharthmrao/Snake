...
class CoordinateTest {
    ...
    void testCoordinate() {
        ...
        assertEquals(5, coordinate.coordinate()[0], "Coordinate should be set correctly.");
        assertEquals(5, coordinate.coordinate()[1], "Coordinate should be set correctly.");
    }
    ...
    void testUpdate() {
        ...
        assertEquals(6, coordinate.coordinate()[0], "Coordinate should be updated correctly.");
        assertEquals(6, coordinate.coordinate()[1], "Coordinate should be updated correctly.");
    }
