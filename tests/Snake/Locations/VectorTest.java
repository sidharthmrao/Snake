...
class VectorTest {
    ...
    void testVector() {
        ...
        assertEquals(5, vector.get(0), "Vector should be set correctly.");
        assertEquals(5, vector.get(1), "Vector should be set correctly.");
    }
    ...
    void testAddVector() {
        ...
        assertEquals(11, vector3.get(0), "Vector should be added correctly.");
        assertEquals(13, vector3.get(1), "Vector should be added correctly.");

        Vector vector4 = vector1.add(new Vector(new int[] {-5, 0}));
        assertEquals(0, vector4.get(0), "Vector should be added correctly.");
        assertEquals(6, vector4.get(1), "Vector should be added correctly.");
    }
    ...
    void testAddCoordinate() {
        ...
        assertEquals(11, coordinate2.get(0), "Vector should be added correctly.");
        assertEquals(13, coordinate2.get(1), "Vector should be added correctly.");

        Coordinate coordinate3 = vector1.add(new Coordinate(new int[] {-5, 0}));
        assertEquals(0, coordinate3.get(0), "Vector should be added correctly.");
        assertEquals(6, coordinate3.get(1), "Vector should be added correctly.");
    }
    ...
    void testMultiplyVector() {
        ...
        assertEquals(10, vector2.get(0), "Vector should be multiplied correctly.");
        assertEquals(12, vector2.get(1), "Vector should be multiplied correctly.");

        Vector vector3 = vector1.multiply(-1);
        assertEquals(-5, vector3.get(0), "Vector should be multiplied correctly.");
        assertEquals(-6, vector3.get(1), "Vector should be multiplied correctly.");
    }
    ...
    void testToCoordinate() {
            ...
            assertEquals(5, coordinate1.get(0), "Vector should be converted correctly.");
            assertEquals(6, coordinate1.get(1), "Vector should be converted correctly.");
    }
